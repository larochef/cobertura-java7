 ...
 * </p>
 */
public abstract class CoverageDataContainer<T extends  CoverageData>
	 ...
	 */
	Map<Object, T> children = new HashMap<Object, T>();
	...
	public void merge(CoverageData coverageData) {
		CoverageDataContainer<T> container =
                (CoverageDataContainer<T>)coverageData;
		getBothLocks(container);
		try {
            for(Object key : container.children.keySet()) {
				T newChild = container.children.get(key);
				T existingChild = this.children.get(key);
